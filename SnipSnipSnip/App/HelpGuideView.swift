                    ...
                    sections: [
                        ...
                        HelpArticleSection(
                            ...
                            bullets: [
                                ...
                                "Guide uses the detected clicked control and available screenshot space to place the numbered marker outside the control when space allows, while keeping it inside the screenshot. The target uses transparent rings so the clicked content remains visible. In the preview, drag the transparent ring around the number to move it, or drag the transparent target ring to point at a different action; the marker follows the pointer throughout the drag. Deleted steps are skipped, so the remaining markers and exported instructions are renumbered continuously from 1.",
