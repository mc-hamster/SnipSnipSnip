...
- Expand and Collapse are permanent, edge-aware affordances rather than incidental header decoration. Compact must show a distinct expand button pointing into the available screen area; Expanded points Collapse back toward its screen edge. Never make recovery from Compact depend on an ellipsis menu, an invisible window background, or remembering that a brand glyph is clickable.
