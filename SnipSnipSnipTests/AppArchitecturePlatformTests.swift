...
final class AppArchitecturePlatformTests: XCTestCase {
    ...
    func testEditorsUseStableCommandRowsAndInspectorWithoutAppModelDependency() throws {
        ...
        XCTAssertFalse(content.contains("private var moreCaptureMenu: some View"))
        XCTAssertFalse(content.contains("accent: .red"))
        XCTAssertFalse(content.contains(".tint(.red)"))
        ...
        XCTAssertTrue(editor.contains("let isSelected = tools.contains(controller.activeTool)"))
